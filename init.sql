...
VALUES (
    ...
    'admin',
    'admin@example.com',
    '$2a$10$zbkkZgkhposppswkYXaMHeZ7qw9WC.ju42f/6ipEIpN7dIhF56Zw.', -- password: admin123; change after first login
    'super_admin',
    true
...
VALUES (
    ...
    '$2a$10$z/k4vZ5049FEKTQyLUN4E.YaEARXAN.rXr0AafL.24YCC9QC/JShu', -- password: wholesale123; change/remove in production
    'wholesale',
    true
) ON CONFLICT (username) DO NOTHING;
